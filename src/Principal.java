...
public class Principal extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        jLabel1.setText("Analizador de Texto ");
        ...
        txtTraduccion.setBackground(new java.awt.Color(204, 255, 255));
        txtTraduccion.setColumns(20);
        txtTraduccion.setRows(5);
        jScrollPane2.setViewportView(txtTraduccion);

        jLabel18.setText("Escriba en el espacio de abajo o abra un archivo");
